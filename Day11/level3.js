...
// for ({ names, capital, languages, population, ...rest } of countries_data) {
//     console.log({ names, capital, population, languages })
// }
...
function convertArrayToObject(arr) {
    ...
    for (const stu of arr) {
        let [name, skills, score] = stu
        result.push({ name: name, skills: skills, score: score })
    }
    return result
}
